...
used as control in the \kw{WCONPROD} is a well set, the lookup machinery will
...
evaluations are in terms of the correct deck units - irrespective of the \kw{UNIT}
...
in deck units, the controls determined by \kw{UDA} evaluation must therefore be
